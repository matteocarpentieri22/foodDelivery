...
public final class InsertOrderDAO extends AbstractDAO<Integer>{
     ...
     */
    private static final String STATEMENT_ORDER_WITH_ID = "INSERT INTO food_delivery.order (id,client_name,client_surname, phone_number, email, id_admin, order_date, collection_date, silverware, box_type, user_id) VALUES (?,?,?, ?, ?, ?, ?, ?, ?,?,?) RETURNING id;";
    ...
    public void doAccess() throws SQLException {
        ...
        try{
            ...
            if(order.getId() > 0){
                ...
                pstmt.setInt(6,order.getIdAdmin());
                ...
                pstmt.setInt(10,order.getBoxType());
