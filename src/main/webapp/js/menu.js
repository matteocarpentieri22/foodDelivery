...
var food_delivery_webapp=window.location.href.replace(host,"");

//console.log(food_delivery_webapp);
food_delivery_webapp=food_delivery_webapp.slice(0,food_delivery_webapp.indexOf("/"));
//console.log(food_delivery_webapp);
var baseURL=host+food_delivery_webapp;
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    let url = baseURL+"/rest/categories"; //CHANGED FROM HTTPS!!
...
function generate_categories_list(categoriesList){
    ...
    if(categoriesList.length > 0){
        ...
        for(var i=0; i<categoriesList.length; i++){
            ...
            var url_products  = baseURL+"/rest/product/category/" + category + "/";
...
function generate_product_list_by_categories(productsList){
    ...
    for (let i = 0; i < productsList.length; i++) {
        (function () {
            ...
            row.classList.add("shadow-sm", "bg-white", "rounded");
            ...
            col_name.classList.add("col", "text-center");
